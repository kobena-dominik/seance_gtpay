...
Contributors: pamilerin
Plugin Repo: https://github.com/billdoss/gtpay-ci-woocommerce
Tags: woocommerce, payment gateway, visa, mastercard, master, verve, interswitch, payment, debit card, credit card, Ivory Coast
Requires at least: 3.3.5
Tested up to: 4.9
Stable tag: 3.4
...
6. Currency - select the currency used for payments. Currently GTPay supports two currencies,  XOF - (566). 
